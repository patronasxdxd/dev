...
|  maxBorrowingRate | [Decimalish](./lib-base.decimalish.md) | Maximum acceptable [borrowing rate](./lib-base.fees.borrowingrate.md) if <code>params</code> includes <code>borrowTHUSD</code>. |
...
The transaction will fail if the Trove's debt would fall below [THUSD\_MINIMUM\_DEBT](./lib-base.thusd_minimum_debt.md)<!-- -->.
