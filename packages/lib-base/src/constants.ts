 ...
 * @public
 */
export const THUSD_LIQUIDATION_RESERVE = Decimal.from(200);

/**
 * A Trove must always have at least this much debt on top of the
 * {@link THUSD_LIQUIDATION_RESERVE | liquidation reserve}.
 *
 * @remarks
 ...
 * @public
 */
export const THUSD_MINIMUM_NET_DEBT = Decimal.from(1800);
 ...
 * @public
 */
export const THUSD_MINIMUM_DEBT = THUSD_LIQUIDATION_RESERVE.add(THUSD_MINIMUM_NET_DEBT);
