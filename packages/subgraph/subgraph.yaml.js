...
const { addresses, startBlock } = require(`@threshold-usd/lib-ethers/deployments/default/tbtc/v1/${network}.json`);
  ...
  - name: StabilityPool
    ...
    mapping:
      ...
      eventHandlers:
        ...
        - event: CollateralGainWithdrawn(indexed address,uint256,uint256)
